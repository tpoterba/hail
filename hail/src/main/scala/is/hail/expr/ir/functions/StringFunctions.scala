...
object StringFunctions extends RegistryFunctions {
  ...
  def registerAll(): Unit = {
    ...
    registerSCode3("substring", TString, TInt32, TInt32, TString, {
      ...
      case (r: EmitRegion, cb, st: SJavaString.type, s, start, end) =>
    ...
    registerSCode1("str", tv("T"), TString, (_: Type, _: SType) => SJavaString) { case (r, cb, st: SJavaString.type, a) =>
    ...
    }) { case (cb, r, st: SJavaString.type, a) =>
    ...
    }) { case (cb, r, st: SJavaString.type, a, trunc) =>
      val jObj = cb.newLocal("showstr_java_obj")(boxedTypeInfo(a.st.virtualType))
    ...
    }) { case (cb: EmitCodeBuilder, region: Value[Region], st: SJavaArrayString,
